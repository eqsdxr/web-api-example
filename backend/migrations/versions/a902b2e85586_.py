...
def upgrade() -> None:
    ...
    op.add_column('users_table', sa.Column('created_at', sa.DateTime(), nullable=False))
    op.add_column('users_table', sa.Column('email', sa.String(length=50), nullable=False))
    op.add_column('users_table', sa.Column('is_activated', sa.Boolean(), nullable=False))
    op.alter_column('users_table', 'password_hash',
